...
output_parser = RegexParser(
    ...
    output_keys=["question1", "A_1", "B_1", "C_1", "D_1", "reponse1","question2", "A_2", "B_2", "C_2", "D_2", "reponse2","question3", "A_3", "B_3", "C_3", "D_3", "reponse3","question4", "A_4", "B_4", "C_4", "D_4", "reponse4"]
)
